...
public class TrelloClientTest {
    ...
    public void init() {
        ...
        when(trelloConfig.getTrelloAppUsername()).thenReturn("mlewicki2");
    }
    ...
    public void shouldFetchTrelloBoards() throws URISyntaxException {
        ...
        URI uri = UriComponentsBuilder.fromHttpUrl(trelloConfig.getTrelloApiEndpoint() + "/members/" + trelloConfig.getTrelloAppUsername() + "/boards")
        ...
        Assert.assertEquals(new ArrayList<>(), fetchedTrelloBoards.get(0).getList());
